"""State directory: spool, checkpoint, config. Same layout as the Claude
Code collector so endpoint tooling can manage both identically."""
...
def spool_path() -> Path:
    return state_dir() / "spool-kimi.jsonl"


def checkpoint_path() -> Path:
    return state_dir() / "checkpoint-kimi.json"
