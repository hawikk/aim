...
Multiple concurrent agent runs worked duplicate issues in
this shared workspace today and produced several competing schema drafts.

**Decision (the canonical-schema issue):** the authoritative schema is
...
was removed on 2026-07-21/34 dedup; history retains it.

**If you are an agent working: stop writing schema files.** is a
duplicate of. See the comment thread on.
