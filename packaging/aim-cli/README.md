...
hook-capable ones (Claude Code, Cursor, Copilot, Kimi, Grok), configures the
scan-based one (Kilo Code), enrolls the device **once**, and verifies connectivity with a
