#!/usr/bin/env bash
# AIM-553 / AIM-597 — multi-replica HA smoke for ingest (compose-shaped).
#
...
# AIM-722: measure app-tier RTO from primary stop → first successful post.
# Kill primary; promote secondary to host port 8080 and prove recovery
