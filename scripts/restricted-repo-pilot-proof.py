#!/usr/bin/env python3
"""proof: pilot restricted-repo enforce + fixtures + break-glass.
...
Usage:
  python3 scripts/restricted-repo-pilot-proof.py
  python3 scripts/restricted-repo-pilot-proof.py --json
"""
...
def main() -> int:
    ...
    print("OK pilot restricted-repo enforce")
    return 0
