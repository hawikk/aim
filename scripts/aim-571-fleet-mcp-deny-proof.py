#!/usr/bin/env python3
"""AIM-571 fleet proof: deny-unlisted MCP on pilot cohort (N≥3 hosts).

After AIM-547/564 enforce flip + non-empty pilot allowlist, prove that the
...
Usage:
  python3 scripts/aim-571-fleet-mcp-deny-proof.py
  python3 scripts/aim-571-fleet-mcp-deny-proof.py --out docs/aim-571-fleet-mcp-deny-evidence.json
...
# Shipped pilot allowlist (AIM-547) — must pass.
ALLOWED_TOOLS = (
