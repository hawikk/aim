#!/usr/bin/env python3
"""Dogfood: endpoint enforcement decision latency SLO (p95 < 200 ms).
...
Usage:
  python3 scripts/enforcement-latency-slo.py
  python3 scripts/enforcement-latency-slo.py --samples 100 --budget-ms 200
