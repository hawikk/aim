#!/usr/bin/env python3
"""AIM-572 — credential-shaped-tool-call precision/recall validation.
...
Usage:
  python3 scripts/aim-572-credential-shaped-precision.py
  python3 scripts/aim-572-credential-shaped-precision.py --json-report /tmp/out.json
  python3 scripts/aim-572-credential-shaped-precision.py --pilot-jsonl events.jsonl
"""
...
def _iter_pilot_events(jsonl: Path | None, dsn: str | None, limit: int | None):
    ...
    spec = importlib.util.spec_from_file_location(
        "aim441", REPO / "scripts" / "aim-441-ruleset-precision.py"
    )
