#!/usr/bin/env node
/**
 * AIM-553 / AIM-600 — synthetic enrollment scale toward ~700 endpoints.
 *
 ...
 *
 * Usage:
 *   ENROLL_TOKEN=dev-enroll-token-change-me node scripts/aim-553-enrollment-scale.mjs
 *
 * Env:
...
console.log("== AIM-600 enrollment scale ==");
console.log(
  JSON.stringify(
