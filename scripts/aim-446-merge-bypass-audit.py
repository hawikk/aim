#!/usr/bin/env python3
"""AIM-446 — audit the last N merges: did every required gate execute and pass?
...
Usage:
  python3 scripts/aim-446-merge-bypass-audit.py
  python3 scripts/aim-446-merge-bypass-audit.py --limit 30 --markdown docs/security/aim-446-bypass-audit.md
"""
...
def to_markdown(payload: dict) -> str:
    s = payload["summary"]
    lines = [
        "# AIM-446 merge bypass audit — last "
        f"{s['limit']} merges\n",
        f"**Repo:** `{s['repo']}`  \n"
    ...
    lines.append(
        ...
        "\nRegenerate:\n\n"
        "```bash\n"
        "python3 scripts/aim-446-merge-bypass-audit.py --limit 30 \\\n"
