#!/usr/bin/env python3
"""Metadata-safe fleet injection dogfood harness.
...
Usage:
  python3 scripts/fleet-injection-dogfood.py
  python3 scripts/fleet-injection-dogfood.py --json-out docs/security/aim-732-fleet-injection-measurement.json
