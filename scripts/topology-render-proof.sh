#!/usr/bin/env bash
# — topology render proof (helm template assertions).
# — topology render proof (helm template assertions).
#
...
#
# Usage: ./scripts/topology-render-proof.sh
...
echo "== enterprise topology render proof =="
echo "== enterprise topology render proof =="
echo "chart: $CHART"
...
# fail-closed: enterprise profile requires OIDC + existingSecret.
