#!/usr/bin/env python3
"""Measure guardrail ruleset precision against the historical corpus.
...
def main() -> int:
    ...
    if args.md_out:
        ...
        lines.extend([
            ...
            "## Notes",
            "",
            "- `unapproved-tool` now matches `tool not_in approved_tools` (fix).",
