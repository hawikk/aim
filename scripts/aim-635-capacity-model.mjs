#!/usr/bin/env node
/**
 * AIM-635 capacity projection for 5k–10k endpoints.
 * Dogfood rates from AIM-323; upper-bound note from AIM-118.
 *
 * Usage:
 *   node scripts/aim-635-capacity-model.mjs
 *   node scripts/aim-635-capacity-model.mjs --devices 700,5000,10000 --burst 10
 */
...
const EVENTS_PER_DEVICE_DAY = 6.833; // AIM-323 measured model
...
const out = {
  ...
  notes: [
    ...
    "AIM-118 upper-bound coding intensity can be 10–100× higher — load-test before 10k cutover.",
