#!/usr/bin/env node
/**
 * AIM-23 acceptance suite for the ingestion pipeline.
 *
 * Implementation-agnostic: runs against any deployed ingest service and
 * checks the AIM-23 acceptance criteria end to end:
 *
 ...
 *
 * Usage:
 *   INGEST_TOKEN=... node scripts/aim-23-ingest-acceptance.mjs
 *
...
/** AIM-18 schema v1 event (metadata-only) — the shape collectors emit. */
