#!/usr/bin/env python3
"""End-to-end for AIM-139 doctor + auto-start, no real AI tool needed.
...
only; run from a checkout:
    ...
    python3 scripts/aim-139-doctor-e2e.py
"""
...
def main() -> int:
    ...
    # collector under aim._vendor, so the pre-AIM-148 `-m aim_collector hook`
