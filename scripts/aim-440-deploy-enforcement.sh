#!/usr/bin/env bash
# AIM-440 — push the declared enforce bundle to this host.
#
# Usage:
#   ./scripts/aim-440-deploy-enforcement.sh           # user state dir (fleet enforce)
#   sudo ./scripts/aim-440-deploy-enforcement.sh --managed
#   ./scripts/aim-440-deploy-enforcement.sh --shadow  # emergency rollback
#   ./scripts/aim-440-deploy-enforcement.sh --pilot   # pilot overlay (PII + AIM-566 restricted-repo)
#   sudo ./scripts/aim-440-deploy-enforcement.sh --pilot --managed
set -euo pipefail
