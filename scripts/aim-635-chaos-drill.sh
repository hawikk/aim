#!/usr/bin/env bash
# AIM-635 / AIM-771 — compose chaos / failure-injection drill (safe subset).
#
# Extends AIM-597 HA smoke with process-kill recovery timings and measurable
...
#
# Usage:
#   ./scripts/aim-635-chaos-drill.sh
# Env:
