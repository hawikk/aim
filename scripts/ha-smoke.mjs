#!/usr/bin/env node
/**
 * Multi-replica HA smoke for API + ingest.
 *
 ...
 *
 * Usage: node scripts/ha-smoke.mjs
...
async function main() {
  console.log("== multi-replica HA smoke ==");
